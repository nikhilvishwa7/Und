...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    "👻 ᴍᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ", url="https://t.me/New_Moviee_hindi"
                ),
    ...
    if len(message.command) != 2:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    "💰 ᴇᴀʀɴ ᴍᴏɴᴇʏ ᴡɪᴛʜ ʙᴏᴛ 💸", callback_data="shortlink_info"
                )
            ],
        ]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**Jᴏɪɴ ᴏᴜʀ ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ👇🏻\n\nCᴀᴍᴇ ʙᴀᴄᴋ ᴀɴᴅ Cʟɪᴄᴋ 👉🏻 Tʀʏ Aɢᴀɪɴ 👈🏻\n\nYᴏᴜ ᴡɪʟʟ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇ 👍🏻...**",
    ...
    if len(message.command) == 2 and message.command[1] in [
        ...
        buttons = [
            ...
            [InlineKeyboardButton("💰 EARN MONEY WITH BOT 💰", callback_data="about")],
        ]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_photo(
            photo=random.choice(PICS),
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton(
                                    "😇ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ😇",
                                    url="https://t.me/+4nzja42ELQwzOWVl",
                                )
                            ],
                        ]
                    ),
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton(
                                    "🫨ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ", url=f"https://t.me/{SUPPORT_CHAT}"
                                ),
    ...
    if data.startswith("sendfiles"):
        ...
        if (
            ...
            g = await get_shortlink(
                chat_id,
                f"https://telegram.me/{temp.U_NAME}?start=allfiles_{file_id}",
                True,
            )
        else:
            g = await get_shortlink(
        ...
        k = await client.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            "🤔 Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ 🤔", url=await get_tutorial(chat_id)
                        )
                    ],
                ]
            ),
    ...
    msg = await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ", url="https://t.me/+4nzja42ELQwzOWVl"
                    )
                ],
            ]
        ),
